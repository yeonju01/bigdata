...
ggplot(gapminder, aes(x=continent, y=lifeExp)) +
  geom_col()
str(gapminder)
table(gapminder$continent, gapminder$lifeExp>70)
subset(gapminder, gapminder$lifeExp>70) 
gapminder %>% 
...
substr(gapminder$country, 8,10)=='Rep'
ggsave('outData/ex17.png')
...
ggsave('outData/ex20.png')

# 21. Ggplot2::economic 데이터 셋의 개인 저축률(psavert)과 실업의이 시간에 따라 서로 어
# 떻게 변해 왔는지 알아보려 한다. 시간에 따른 개인 저축률과 실업률의 변화를 한 그래프에 중
# 첩하여 시각화하시오
